...
namespace BwElasticExportGoogleShopping\Generator;
...
use BwElasticExportGoogleShopping\Helper\AttributeHelper;
use BwElasticExportGoogleShopping\Helper\PriceHelper;
...
use BwElasticExportGoogleShopping\Helper\ImageHelper;

/**
 * Class GoogleShopping
 *
 * @package BwElasticExportGoogleShopping\Generator
 */
            ...
            do {
                ...
                if ($shardIterator == 1) {
                    $this->getLogger(__METHOD__)
                        ...
                        ->debug('BwElasticExportGoogleShopping::logs.esResultAmount');
                }
...
//                    'VariationStock',
    ...
    private function buildRow($variation, $settings, $counter)
    {
        ...
        $data = [
            ...
            'counter_id' => $counter,
            'free_shipping_threshold' => 'DE:50 EUR'
        ];
